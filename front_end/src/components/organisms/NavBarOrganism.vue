<template>
  <div class="shadow-lg sticky top-0 bg-white z-[10] py-2 px-5 md:py-3 lg:px-20">
    <div
      v-if="hiddenNavBar()"
    ...
    >
      <!-- left navbar -->
      <div
        class="mr-5 md:col-span-2 md:mr-10 xl:hidden h-full flex items-center"
      >
        <font-awesome-icon
    ...
    <MainMenuMolecule
      class="xl:flex xl:justify-center xl:items-center"
