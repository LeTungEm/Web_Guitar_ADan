<template>
  <div v-if="hiddenNavBar()" class="hidden text-sm py-1 bg-gray-300 text-black lg:flex lg:justify-between lg:px-20 lg:items-center">
    <!-- <SubNavInfoMolecule /> -->
    <h1>Dia Chi Cua Hang</h1>
    <SocialMolecule class="text-gray-600"/>
    <h1>Dia Chi Cua Hang</h1>
  </div>
</template>
