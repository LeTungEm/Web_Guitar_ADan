<template>
  <PageTemplate v-if="catInfo != null" class="relative">
    <div class="lg:flex gap-10">
      ...
      />
      <!-- info -->
      <div class="lg:w-1/2 backdrop-blur-sm p-1">
        <!-- link -->
        <div
        ...
        <!-- Cat Info -->
        <div>
          <h1 class="capitalize text-white text-3xl font-bold">{{ catInfo.name }}</h1>
          ...
          <div class="mt-5">
            <div class="text-2xl text-white underline font-bold">Đặc điểm nổi bật</div>
            <div v-html="catInfo.outstanding" class="text-xl"></div>
          </div>
        </div>
        <!-- contact -->
        <div class="mt-10">
