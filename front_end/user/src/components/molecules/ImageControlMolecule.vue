<template>
  <div class="lg:w-1/2 flex flex-col-reverse lg:flex-row gap-5 mb-5 lg:mb-0 z-[9]">
    <div
      ...
      <div class="p-1 border border-gray-300 shadow-md">
        <div class="p-1 border relative">
          <div id="img-container" class="image_contain [&>*]:object-contain">
            <img
              :src="`${doman}/back_end/api/Controllers/GetFileController.php?imgURL=${showedImg}&width=700`"
              alt=""
            />
          </div>
          <!-- Button Zoom -->
          ...
          >
            <img
              ...
              :src="`${doman}/back_end/api/Controllers/GetFileController.php?imgURL=${showedImg}`"
              alt=""
            />
          </div>
        </div>
    ...
    listImageLink: function (newValue) {
      if (newValue) {
        ...
        if (arrImage.length > 0) {
          ...
          this.listImg = ["default.jpg"];
          this.showedImg = "default.jpg";
    ...
    initZoomer() {
      if (window.outerWidth >= 1280) {
        ...
        let options = {
          ...
          img: `${this.doman}/back_end/api/Controllers/GetFileController.php?imgURL=${this.showedImg}&width=700`,
        };
